...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    window->DrawList->AddRectFilled( clickable.Min, clickable.Max,  IM_COL32(34, 34, 36, style.Alpha), 3 );
    window->DrawList->AddRect( clickable.Min, clickable.Max, ImColor( 1.f, 1.f, 1.f, 0.03f * style.Alpha ), 3 );
